...
CREATE TABLE IF NOT EXISTS TurbineReadings (
    Id UUID PRIMARY KEY,
...
-- Table: TurbineEvents
CREATE TABLE IF NOT EXISTS TurbineEvents (
    Id UUID PRIMARY KEY,
    TurbineId UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS ComponentStatuses (
    Id UUID PRIMARY KEY,
    TurbineId UUID NOT NULL,
...
CREATE INDEX IF NOT EXISTS IX_TurbineReadings_TurbineId ON TurbineReadings(TurbineId);
CREATE INDEX IF NOT EXISTS IX_TurbineReadings_Timestamp ON TurbineReadings(Timestamp DESC);
CREATE INDEX IF NOT EXISTS IX_TurbineEvents_TurbineId ON TurbineEvents(TurbineId);
CREATE INDEX IF NOT EXISTS IX_TurbineEvents_CreatedAt ON TurbineEvents(CreatedAt DESC);
CREATE INDEX IF NOT EXISTS IX_ComponentStatuses_TurbineId ON ComponentStatuses(TurbineId);
CREATE INDEX IF NOT EXISTS IX_MaintenanceSchedules_TurbineId ON MaintenanceSchedules(TurbineId);
CREATE INDEX IF NOT EXISTS IX_MaintenanceSchedules_ScheduledDate ON MaintenanceSchedules(ScheduledDate);
